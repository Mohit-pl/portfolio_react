...
import pro from "../assets/john-doe.jpg"
    ...
    <div name="home" className='h-screen bg-gradient-to-b from-black via-black to-gray-800'>
      <div className='max-w-screen-lg mx-auto flex flex-col justify-center items-center h-full px-4 md:flex-row' >
        <div className='flex justify-center flex-col h-3/4 md:h-full'>
          ...
          <p className='text-gray-500 py-4 w-full'>Hii Mohit Pal here, I am from Delhi my major skills
           are Reactjs,Javascript,html+css thanks for visiting my page checkout my portfolio.Currently
            looking for an "entry level job" as a Frontend web Developer  </p>
        <div >
